...
public class UnHappyTests extends base {
	...
	@Test
	public void urlhomePageIntellisense() throws IOException, InterruptedException
	{	
		...
		dp.getdashBoardDropdown().click(); // Clicks on Link DadhBoard DropDown
		driver.findElement(By.xpath("//li[@ui-route='/id/dashboards/665']")).click(); // Clicks on Naveen DashBoard Name 
		System.out.println(driver.findElement(By.xpath("//h1[@class='title']")).getText()); // Prints the DashBoard Name Naveen
		dp.getIntelliSense().click(); // Clicks on INtelliSense.io Icon
		String cUrl = driver.getCurrentUrl(); // Storing the Current page URL into a string
