...
public class UnHappyTests2 extends base {
	...
	@Test
	public void HomePageURL() throws IOException, InterruptedException
	{
		...
		dp.getdashBoardDropdown().click(); // Click on DashBoard dropdown
		...
		String cUrl = driver.getCurrentUrl(); // Storing current URL into a string
